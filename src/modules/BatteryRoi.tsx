...
export default function BatteryRoi() {
  ...
  useEffect(() => { 
    (subscribe as any)("plan.selected", (e: any) => setSelectedPlan(e.plan)); 
  }, []);
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-3 rounded-xl border border-white/20 bg-white/5">
                ...
                <div className="text-xs opacity-80">Coming soon - AI-optimized sizing</div>
              </div>
              <div className="p-3 rounded-xl border border-white/20 bg-white/5">
                <div className="text-sm font-medium">Expected ROI</div>
                <div className="text-xs opacity-80">AI analysis in progress</div>
              </div>
            </div>
          </div>
        </div>
