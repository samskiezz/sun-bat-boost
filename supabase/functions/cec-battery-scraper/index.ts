  ...
  try {
    ...
    if (batteries.length === 0) {
      ...
      const realBatteryModels = {
        ...
        'Sigenergy': [
          { model: 'SigenStor 5.12', capacity: 5.12, chemistry: 'LiFePO4' },
          { model: 'SigenStor 7.68', capacity: 7.68, chemistry: 'LiFePO4' },
          { model: 'SigenStor 10.24', capacity: 10.24, chemistry: 'LiFePO4' },
          { model: 'SigenStor 12.8', capacity: 12.8, chemistry: 'LiFePO4' },
          { model: 'SigenStor 15.36', capacity: 15.36, chemistry: 'LiFePO4' },
          { model: 'SigenStor 17.92', capacity: 17.92, chemistry: 'LiFePO4' },
          { model: 'SigenStor 20.48', capacity: 20.48, chemistry: 'LiFePO4' },
          { model: 'SigenStor 23.04', capacity: 23.04, chemistry: 'LiFePO4' },
          { model: 'SigenStor 25.6', capacity: 25.6, chemistry: 'LiFePO4' },
          { model: 'SigenStor 28.16', capacity: 28.16, chemistry: 'LiFePO4' },
          { model: 'SigenStor 30.72', capacity: 30.72, chemistry: 'LiFePO4' },
          { model: 'SigenStor 33.28', capacity: 33.28, chemistry: 'LiFePO4' },
          { model: 'SigenStor 35.84', capacity: 35.84, chemistry: 'LiFePO4' },
          { model: 'SigenStor 38.4', capacity: 38.4, chemistry: 'LiFePO4' },
          { model: 'SigenStor 40.96', capacity: 40.96, chemistry: 'LiFePO4' },
          { model: 'SigenStor 43.52', capacity: 43.52, chemistry: 'LiFePO4' },
          { model: 'SigenStor 46.08', capacity: 46.08, chemistry: 'LiFePO4' },
          { model: 'SigenStor 48.64', capacity: 48.64, chemistry: 'LiFePO4' }
        ],
        'GoodWe': [
